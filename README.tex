...
\chapter{Agenda}
\label{sec:org9594aa1}

Quelques sujets que l'on pourrait aborder :

\begin{itemize}
\item mon parcours avec Emacs ;
\item le thème (officiel) de couleurs \hyperref[sec:org9f5ae3d]{Leuven} ;
\item ma configuration Emacs (\og \hyperref[sec:org11a57b3]{Emacs Leuven}\fg{}) ;
\item \hyperref[sec:org973ae49]{org-html-themes} ;
\item \hyperref[sec:orgac839ac]{boost-org-latex-toolkit} ;
\item \hyperref[sec:orgfb8d79d]{mon organisation quotidienne} ;
\item \hyperref[sec:org1b95bad]{quelques astuces} et automatisations ;
\item les \hyperref[sec:org4c47529]{formations EmacsBoost}.
\end{itemize}

Tous ces projets répondent à des besoins rencontrés dans mon travail quotidien.
\chapter{leuven-theme}
\label{sec:org9f5ae3d}
...
\section{VCS (Git)}
\label{sec:org6af2ba0}

\subsection*{EDiff}
\label{sec:orgcd6a39d}
...
\label{sec:org755857c}

\section{Automatisations dans Dired}
\label{sec:org47379de}
