...
\chapter{Agenda}
\label{sec:org616a32c}

Quelques sujets que l'on pourrait aborder :

\begin{itemize}
\item mon parcours avec Emacs ;
\item le thème (officiel) de couleurs \hyperref[sec:org17ee7cf]{Leuven} ;
\item ma configuration Emacs (\og \hyperref[sec:org1a9edcf]{Emacs Leuven}\fg{}) ;
\item \hyperref[sec:org60336e4]{org-html-themes} ;
\item \hyperref[sec:org480c1cc]{boost-org-latex-toolkit} ;
\item \hyperref[sec:orgf22ad61]{mon organisation quotidienne} ;
\item \hyperref[sec:org45d13d3]{quelques astuces} et automatisations ;
\item les \hyperref[sec:org4217fdc]{formations EmacsBoost}.
\end{itemize}

Tous ces projets répondent à des besoins rencontrés dans mon travail quotidien.
\chapter{leuven-theme}
\label{sec:org17ee7cf}
...
\section{VCS (Git)}
\label{sec:org8515b8c}

\subsection*{EDiff}
\label{sec:org729371c}
