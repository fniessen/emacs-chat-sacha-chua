...
\chapter{Agenda}
\label{sec:org01d5d44}

Quelques sujets que l'on pourrait aborder :

\begin{itemize}
\item mon parcours avec Emacs ;
\item le thème (officiel) de couleurs \hyperref[sec:org4d04cb6]{Leuven} ;
\item ma configuration Emacs (\og \hyperref[sec:org6747712]{Emacs Leuven}\fg{}) ;
\item \hyperref[sec:orgfee417b]{org-html-themes} ;
\item \hyperref[sec:org8ab5f78]{boost-org-latex-toolkit} ;
\item \hyperref[sec:org5fcc941]{mon organisation quotidienne} ;
\item \hyperref[sec:orga2472ec]{quelques astuces} et automatisations ;
\item les \hyperref[sec:org5082260]{formations EmacsBoost}.
\end{itemize}

Tous ces projets répondent à des besoins rencontrés dans mon travail quotidien.
\chapter{leuven-theme}
\label{sec:org4d04cb6}
...
\section{VCS (Git)}
\label{sec:org4f3cd91}

\subsection*{EDiff}
\label{sec:orgac002fb}
