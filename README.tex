...
\chapter{Agenda}
\label{sec:org50ddfb3}

Quelques sujets que l'on pourrait aborder :

\begin{itemize}
\item mon parcours avec Emacs ;
\item le thème (officiel) de couleurs Leuven ;
\item ma configuration Emacs (\og Emacs Leuven\fg{}) ;
\item org-html-themes ;
\item boost-org-latex-toolkit ;
\item mon organisation quotidienne ;
\item quelques astuces et automatisations ;
\item les formations EmacsBoost.
\end{itemize}
...
\label{sec:orga1ceffe}

Quelques petites choses qui font \textbf{gagner beaucoup de temps}.
\section{M-w sans sélectionner de région}
\label{sec:orgac62712}
...
\section{VCS (Git)}
\label{sec:orgae5e629}

\subsection*{EDiff}
\label{sec:org2c9e8ea}
...
\label{sec:org7952767}

\section{Automatisations dans Dired}
\label{sec:orgca7b746}
