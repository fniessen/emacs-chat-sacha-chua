...
\chapter{Agenda}
\label{sec:orged8d49f}

Quelques sujets que l'on pourrait aborder :

\begin{itemize}
\item mon parcours avec Emacs ;
\item le thème (officiel) de couleurs \hyperref[sec:org02a18e2]{Leuven} ;
\item ma configuration Emacs (\og \hyperref[sec:org698358e]{Emacs Leuven}\fg{}) ;
\item \hyperref[sec:org18d0a6f]{org-html-themes} ;
\item \hyperref[sec:org0f4a9e6]{boost-org-latex-toolkit} ;
\item \hyperref[sec:orgbcaa3e4]{mon organisation quotidienne} ;
\item \hyperref[sec:org2a93cc3]{quelques astuces} et automatisations ;
\item les \hyperref[sec:orgd150dc3]{formations EmacsBoost}.
\end{itemize}

Tous ces projets répondent à des besoins rencontrés dans mon travail quotidien.
\chapter{leuven-theme}
\label{sec:org02a18e2}
...
\section{VCS (Git)}
\label{sec:org6113603}

\subsection*{EDiff}
\label{sec:orgef456ce}
...
\label{sec:org2641b2b}

\begin{center}
\begin{tabular}{ll}
Touche & Commande\\
\hline
\lstinline|C-o| & \lstinline|helm-swoop-from-isearch| (dans \lstinline|isearch-mode-map|)\\
\end{tabular}
\end{center}

Nombre de correspondances grâce à Anzu.
\section{Autres raccourcis de productivité}
\label{sec:org735d8f6}
