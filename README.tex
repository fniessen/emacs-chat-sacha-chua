...
\chapter{Agenda}
\label{sec:org3830d82}

Quelques sujets que l'on pourrait aborder :

\begin{itemize}
\item mon parcours avec Emacs ;
\item le thème (officiel) de couleurs \hyperref[sec:org40203cc]{Leuven} ;
\item ma configuration Emacs (\og \hyperref[sec:orgb911a05]{Emacs Leuven}\fg{}) ;
\item \hyperref[sec:org0f0c2e0]{org-html-themes} ;
\item \hyperref[sec:org4536a50]{boost-org-latex-toolkit} ;
\item \hyperref[sec:orgbde9319]{mon organisation quotidienne} ;
\item \hyperref[sec:orgdda8814]{quelques astuces} et automatisations ;
\item les \hyperref[sec:orgb8405ee]{formations EmacsBoost}.
\end{itemize}

Tous ces projets répondent à des besoins rencontrés dans mon travail quotidien.
\chapter{leuven-theme}
\label{sec:org40203cc}
...
\section{VCS (Git)}
\label{sec:org0c6a5ab}

\subsection*{EDiff}
\label{sec:org1e7e6ff}
...
\end{center}
\section{GPTel}
\label{sec:org56663e1}

\subsection*{Buffer de conversation}
\label{sec:orgf4589f0}
...
Référence :
\url{https://github.com/fniessen/emacs-boost-gptel/blob/master/README.org\#14-chat-interface}
\subsection*{GPTel-commit-msg}
\label{sec:org834ed31}
