...
\chapter{Agenda}
\label{sec:org491b73f}

Quelques sujets que l'on pourrait aborder :

\begin{itemize}
\item mon parcours avec Emacs ;
\item le thème (officiel) de couleurs \hyperref[sec:orgdeae36e]{Leuven} ;
\item ma configuration Emacs (\og \hyperref[sec:orgd446370]{Emacs Leuven}\fg{}) ;
\item \hyperref[sec:org26609d0]{org-html-themes} ;
\item \hyperref[sec:orgf7d52b3]{boost-org-latex-toolkit} ;
\item \hyperref[sec:orga86a728]{mon organisation quotidienne} ;
\item \hyperref[sec:org88926f3]{quelques astuces} et automatisations ;
\item les \hyperref[sec:org51e95ce]{formations EmacsBoost}.
\end{itemize}

Tous ces projets répondent à des besoins rencontrés dans mon travail quotidien.
\chapter{leuven-theme}
\label{sec:orgdeae36e}
...
\section{VCS (Git)}
\label{sec:org424a23f}

\subsection*{EDiff}
\label{sec:orgd930048}
