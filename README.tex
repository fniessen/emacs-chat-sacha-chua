...
\chapter{Agenda}
\label{sec:org2d963e7}

Quelques sujets que l'on pourrait aborder :

\begin{itemize}
\item mon parcours avec Emacs ;
\item le thème (officiel) de couleurs \hyperref[sec:org3c2495c]{Leuven} ;
\item ma configuration Emacs (\og \hyperref[sec:org63f802e]{Emacs Leuven}\fg{}) ;
\item \hyperref[sec:org81ef79e]{org-html-themes} ;
\item \hyperref[sec:org326b804]{boost-org-latex-toolkit} ;
\item \hyperref[sec:org691fdfe]{mon organisation quotidienne} ;
\item \hyperref[sec:orgf282d89]{quelques astuces} et automatisations ;
\item les \hyperref[sec:org2fc546c]{formations EmacsBoost}.
\end{itemize}

Tous ces projets répondent à des besoins rencontrés dans mon travail quotidien.
\chapter{leuven-theme}
\label{sec:org3c2495c}
...
\section{VCS (Git)}
\label{sec:org06c11a2}

\subsection*{EDiff}
\label{sec:org367b84a}
