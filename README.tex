...
\chapter{Agenda}
\label{sec:org2210e22}

Quelques sujets que l'on pourrait aborder :

\begin{itemize}
\item mon parcours avec Emacs ;
\item le thème (officiel) de couleurs \hyperref[sec:org212b4c9]{Leuven} ;
\item ma configuration Emacs (\og \hyperref[sec:orgdab823f]{Emacs Leuven}\fg{}) ;
\item \hyperref[sec:orga4a2c62]{org-html-themes} ;
\item \hyperref[sec:org53ba033]{boost-org-latex-toolkit} ;
\item \hyperref[sec:orgcc65dae]{mon organisation quotidienne} ;
\item \hyperref[sec:org2034ada]{quelques astuces} et automatisations ;
\item les \hyperref[sec:org57ba32c]{formations EmacsBoost}.
\end{itemize}

Tous ces projets répondent à des besoins rencontrés dans mon travail quotidien.
\chapter{leuven-theme}
\label{sec:org212b4c9}
...
\section{VCS (Git)}
\label{sec:org238e2e5}

\subsection*{EDiff}
\label{sec:org244f1af}
