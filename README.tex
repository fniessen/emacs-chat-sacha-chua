...
\chapter{Agenda}
\label{sec:orge0bfe35}

Quelques sujets que l'on pourrait aborder :

\begin{itemize}
\item mon parcours avec Emacs ;
\item le thème (officiel) de couleurs \hyperref[sec:org1691f13]{Leuven} ;
\item ma configuration Emacs (\og \hyperref[sec:orgeb405b9]{Emacs Leuven}\fg{}) ;
\item \hyperref[sec:orgdba35f4]{org-html-themes} ;
\item \hyperref[sec:orgdfe2bbf]{boost-org-latex-toolkit} ;
\item \hyperref[sec:org3e039b3]{mon organisation quotidienne} ;
\item \hyperref[sec:org4e12449]{quelques astuces} et automatisations ;
\item les \hyperref[sec:orgbea99c4]{formations EmacsBoost}.
\end{itemize}

Tous ces projets répondent à des besoins rencontrés dans mon travail quotidien.
\chapter{leuven-theme}
\label{sec:org1691f13}
...
\section{VCS (Git)}
\label{sec:org04aabdb}

\subsection*{EDiff}
\label{sec:org290443b}
...
\end{center}
\section{GPTel}
\label{sec:orgb87ca90}

\subsection*{Buffer de conversation}
\label{sec:org475e9c9}
...
\section{Dotfiler (type GNU Stow) pour tous mes repos}
\label{sec:orgafdb445}
