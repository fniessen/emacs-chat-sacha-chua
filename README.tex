...
\chapter{Agenda}
\label{sec:orgf222a49}

Quelques sujets que l'on pourrait aborder :

\begin{itemize}
\item mon parcours avec Emacs ;
\item le thème (officiel) de couleurs \hyperref[sec:orgc0ee410]{Leuven} ;
\item ma configuration Emacs (\og \hyperref[sec:org4f40f22]{Emacs Leuven}\fg{}) ;
\item \hyperref[sec:org9527359]{org-html-themes} ;
\item \hyperref[sec:org8f877db]{boost-org-latex-toolkit} ;
\item \hyperref[sec:org57ea62d]{mon organisation quotidienne} ;
\item \hyperref[sec:orgcafbbce]{quelques astuces} et automatisations ;
\item les \hyperref[sec:org0270966]{formations EmacsBoost}.
\end{itemize}

Tous ces projets répondent à des besoins rencontrés dans mon travail quotidien.
\chapter{leuven-theme}
\label{sec:orgc0ee410}
...
\section{VCS (Git)}
\label{sec:orgff51798}

\subsection*{EDiff}
\label{sec:orgf4739b1}
