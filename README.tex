...
\chapter{Agenda}
\label{sec:orgf382e6e}

Quelques sujets que l'on pourrait aborder :

\begin{itemize}
\item mon parcours avec Emacs ;
\item le thème (officiel) de couleurs \hyperref[sec:orgb9d5b89]{Leuven} ;
\item ma configuration Emacs (\og \hyperref[sec:org88220d0]{Emacs Leuven}\fg{}) ;
\item \hyperref[sec:orgc8d3f15]{org-html-themes} ;
\item \hyperref[sec:org5e971ea]{boost-org-latex-toolkit} ;
\item \hyperref[sec:org2bf5840]{mon organisation quotidienne} ;
\item \hyperref[sec:org925cc40]{quelques astuces} et automatisations ;
\item les \hyperref[sec:org6fbd05b]{formations EmacsBoost}.
\end{itemize}

Tous ces projets répondent à des besoins rencontrés dans mon travail quotidien.
\chapter{leuven-theme}
\label{sec:orgb9d5b89}
...
\section{VCS (Git)}
\label{sec:orgd7a67d2}

\subsection*{EDiff}
\label{sec:orgb12edf4}
...
\end{center}
\section{GPTel}
\label{sec:org53f1ce3}

\subsection*{Buffer de conversation}
\label{sec:org27d88c8}
