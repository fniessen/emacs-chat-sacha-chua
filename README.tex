...
\chapter{Agenda}
\label{sec:org4da35a5}

Quelques sujets que l'on pourrait aborder :

\begin{itemize}
\item mon parcours avec Emacs ;
\item le thème (officiel) de couleurs \hyperref[sec:orgfe01847]{Leuven} ;
\item ma configuration Emacs (\og \hyperref[sec:org3f94de7]{Emacs Leuven}\fg{}) ;
\item \hyperref[sec:org4756472]{org-html-themes} ;
\item \hyperref[sec:orge511ae5]{boost-org-latex-toolkit} ;
\item \hyperref[sec:org51f35ea]{mon organisation quotidienne} ;
\item \hyperref[sec:orgebe708f]{quelques astuces} et automatisations ;
\item les \hyperref[sec:orgb33f880]{formations EmacsBoost}.
\end{itemize}

Tous ces projets répondent à des besoins rencontrés dans mon travail quotidien.
\chapter{leuven-theme}
\label{sec:orgfe01847}
...
\section{VCS (Git)}
\label{sec:orgc67248d}

\subsection*{EDiff}
\label{sec:org1a9ca06}
...
\label{sec:org1f033b5}

\section{Automatisations dans Dired}
\label{sec:org5648c97}
...
\hline
\lstinline|M-S-a| & \lstinline|boost-reveal-hidden-text|\\
\end{tabular}
\end{center}
\chapter{Formations EmacsBoost}
\label{sec:orgb33f880}
