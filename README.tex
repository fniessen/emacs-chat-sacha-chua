...
\chapter{Agenda}
\label{sec:org895f516}

Quelques sujets que l'on pourrait aborder :

\begin{itemize}
\item mon parcours avec Emacs ;
\item le thème (officiel) de couleurs \hyperref[sec:orgcec1afd]{Leuven} ;
\item ma configuration Emacs (\og \hyperref[sec:org1b8ec81]{Emacs Leuven}\fg{}) ;
\item \hyperref[sec:org39d16ad]{org-html-themes} ;
\item \hyperref[sec:orga5ab641]{boost-org-latex-toolkit} ;
\item \hyperref[sec:org9988cd8]{mon organisation quotidienne} ;
\item \hyperref[sec:org114c0c3]{quelques astuces} et automatisations ;
\item les \hyperref[sec:org98776d0]{formations EmacsBoost}.
\end{itemize}

Tous ces projets répondent à des besoins rencontrés dans mon travail quotidien.
\chapter{leuven-theme}
\label{sec:orgcec1afd}
...
\section{VCS (Git)}
\label{sec:org8ce9c0e}

\subsection*{EDiff}
\label{sec:org40aebb2}
...
\label{sec:orgccb6718}

\section{Automatisations dans Dired}
\label{sec:orgc527ab6}
