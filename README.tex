...
\chapter{Agenda}
\label{sec:org0a1d29b}

Quelques sujets que l'on pourrait aborder :

\begin{itemize}
\item mon parcours avec Emacs ;
\item le thème (officiel) de couleurs \hyperref[sec:org2768289]{Leuven} ;
\item ma configuration Emacs (\og \hyperref[sec:org6e1f25c]{Emacs Leuven}\fg{}) ;
\item \hyperref[sec:org1dda9f9]{org-html-themes} ;
\item \hyperref[sec:org97d2312]{boost-org-latex-toolkit} ;
\item \hyperref[sec:org8504c77]{mon organisation quotidienne} ;
\item \hyperref[sec:org1b2bef6]{quelques astuces} et automatisations ;
\item les \hyperref[sec:orgd79f177]{formations EmacsBoost}.
\end{itemize}

Tous ces projets répondent à des besoins rencontrés dans mon travail quotidien.
\chapter{leuven-theme}
\label{sec:org2768289}
...
\section{VCS (Git)}
\label{sec:org51fb8c9}

\subsection*{EDiff}
\label{sec:org9b6b6f0}
