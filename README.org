...
Les touches de fonction ci-dessous fournissent un environnement de travail
inspiré de Borland Pascal pour les opérations les plus courantes : gestion des
fichiers, navigation entre fenêtres, macros clavier, contrôle de version,
navigation dans les erreurs de compilation et gestion des buffers.
