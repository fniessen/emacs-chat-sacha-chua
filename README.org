...
#+ATTR_HTML: :style margin-left:auto; margin-right:0; background:#f2f2f2;
...
#+TBLFM: @1$2=vsum(remote(participants,@2$3..@>$3));%.2f::@2$2=@1*0.21;%.2f::@3$2=vsum(@1..@-1);*%.2f*
#+LATEX: \end{minipage}}
...
structuré. Elle fait gagner énormément de temps lorsqu'on travaille
quotidiennement avec du texte semi-structuré.
