...
The following function keys provide a Borland Pascal-like workflow for file
management, window navigation, keyboard macros, version control, compilation
errors, and buffer management.
